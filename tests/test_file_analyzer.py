...
def test_normal_pdf_signature_does_not_create_risk(
    tmp_path: Path,
) -> None:
    file_path = (
        tmp_path
...
def test_archive_signature_reaching_file_analyzer_is_marked_unsupported(
    tmp_path: Path,
) -> None:
    file_path = (
        tmp_path
...
def test_suspicious_string_group_is_capped(
    tmp_path: Path,
) -> None:
    file_path = (
        tmp_path
...
def test_combined_independent_evidence_can_reach_critical(
    tmp_path: Path,
) -> None:
    file_path = (
        tmp_path
...
def test_small_file_is_not_flagged_for_entropy_alone(
    tmp_path: Path,
) -> None:
    file_path = (
        tmp_path
...
def test_large_file_sample_includes_tail(
    tmp_path: Path,
) -> None:
    file_path = (
        tmp_path
...
def test_relative_path_extension_is_used(
    tmp_path: Path,
) -> None:
    file_path = (
        tmp_path
